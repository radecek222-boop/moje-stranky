...
<?php endif; ?>
  ...
  <!-- Detail overlay modal — MUSÍ být po universal-modal-theme pro správné přebití -->
  <link rel="stylesheet" href="assets/css/modal-detail.min.css?v=<?= filemtime(__DIR__ . '/assets/css/modal-detail.min.css') ?>">
<style>
/* ============================================
   POZOR: Pravidla pro #detailOverlay jsou přesunuta do:
   assets/css/modal-detail.css (a .min.css)
...
.modal-overlay:not(#detailOverlay) .modal-content {
  ...
  /* #detailOverlay pravidla přesunuta do assets/css/modal-detail.css */
  /* Neupravovat zde. Editovat: assets/css/modal-detail.css */
