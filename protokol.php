...
<div class="wrapper">
  ...
  <div class="two-col-table">
    <div class="col">
      <table>
        <tr><td class="label"><strong>Celkem k úhradě za servis</strong><span class="en-label">Total service payment</span></td><td><input type="text" id="price-total" placeholder="0.00" style="font-weight:700;"></td></tr>
