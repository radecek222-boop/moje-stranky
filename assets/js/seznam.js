        ...
        <div class="detail-sloupec-pravy">
          ...
          <div style="margin-bottom: 0.75rem;">
            ...
            <textarea id="edit_popis_problemu" class="detail-textarea-popis"
                      style="width: 100%; border: 1px solid #555; padding: 0.6rem; border-radius: 3px; background: #2a2a2a; color: #fff; -webkit-text-fill-color: #fff; font-size: ${window.innerWidth <= 768 ? '16px' : '0.85rem'}; resize: none; font-family: inherit; overflow: hidden;"
