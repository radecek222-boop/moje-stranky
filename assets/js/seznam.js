...
function showContactMenu(id) {
  ...
  const textPrijedu = `Dobrý den, jsem na cestě k vám na adresu ${address} ohledně domluvené servisní návštěvy. Přijedu za zhruba 30min podle situace v dopravě. Technik ${technikJmeno} White Glove Servis`;
