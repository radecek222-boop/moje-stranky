...
async function showCustomerDetail(id) {
        ...
        <div class="detail-sloupec-pravy">
          ...
          <div style="margin-bottom: 0.75rem;">
            ...
            <textarea id="edit_popis_problemu" class="detail-textarea-popis"
                      style="width: 100%; border: 1px solid #333; padding: 0.6rem; border-radius: 3px; min-height: 80px; background: #fff; color: #000; font-size: ${window.innerWidth <= 768 ? '18px' : '0.85rem'}; resize: none; font-family: inherit; overflow: hidden;"
  ...
  setTimeout(() => {
    ...
    textareas.forEach(ta => {
      if (ta) {
        ta.style.setProperty('font-size', jeMobil ? '18px' : '0.85rem', 'important');
