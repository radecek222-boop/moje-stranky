  ...
  const content = `
    ...
    <div class="modal-body" style="max-height: 70vh; overflow-y: auto; padding: 1rem;">
      ...
      <div style="margin-bottom: 0.75rem;">
        <label style="display: block; color: #aaa; font-weight: 600; font-size: 1.1rem; margin-bottom: 0.25rem;">Popis problému od zákazníka:</label>
        <textarea id="edit_popis_problemu"
                  style="width: 100%; border: 1px solid #333; padding: 0.5rem; border-radius: 3px; font-size: 1.2rem; min-height: 70px; background: #fff; color: #000; resize: none; font-family: inherit; overflow: hidden;"
      ...
      <div style="margin-bottom: 0.75rem;">
        <label style="display: block; color: #aaa; font-weight: 600; font-size: 1.1rem; margin-bottom: 0.25rem;">Doplňující informace od prodejce:</label>
