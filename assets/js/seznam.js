  ...
  const content = `
    ...
    <div class="modal-body">
      <div class="detail-buttons">
        ...
        ${phone ? `<button class="detail-btn detail-btn-primary" data-action="sendContactAttemptEmail" data-id="${id}" data-phone="${phone}" style="color: #dc3545; border: 2px solid #dc3545; box-shadow: 0 0 8px rgba(220,53,69,0.5), 0 0 16px rgba(220,53,69,0.2);">NEZVEDA SMS</button>` : ''}
        <button class="detail-btn detail-btn-primary" data-action="openCalendarFromDetail" data-id="${id}">Termín návštěvy</button>
        ${address && address !== '—' ? `<a href="https://waze.com/ul?q=${encodeURIComponent(address)}&navigate=yes" class="detail-btn detail-btn-primary" style="text-decoration: none; color: #0099ff; border: 2px solid #0099ff; box-shadow: 0 0 8px rgba(0,153,255,0.5), 0 0 16px rgba(0,153,255,0.2);" target="_blank">Navigovat (Waze)</a>` : ''}
        ...
        ${phone ? `<a href="sms:${phone}?body=${encodeURIComponent(textPrijedu)}" class="detail-btn detail-btn-primary" style="text-decoration: none; color: #39ff14; border: 2px solid #39ff14; box-shadow: 0 0 8px rgba(57,255,20,0.5), 0 0 16px rgba(57,255,20,0.2);">PŘIJEDU ZA 30</a>` : ''}
