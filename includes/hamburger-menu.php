...
<script src="/assets/js/language-switcher.min.js?v=<?= is_file(__DIR__ . '/../assets/js/language-switcher.min.js') ? filemtime(__DIR__ . '/../assets/js/language-switcher.min.js') : '0' ?>" defer></script>
