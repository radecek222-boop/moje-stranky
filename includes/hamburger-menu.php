...
<header class="hamburger-header">
  ...
  <nav class="hamburger-nav <?php echo $isAdmin ? 'admin-nav-active' : ''; ?>" id="hamburger-nav" aria-label="Hlavní navigace">
    ...
    ?>
      ...
      <a href="/" <?php if($current == "nasesluzby.php") echo 'class="active" aria-current="page"'; ?> data-lang-cs="NAŠE SLUŽBY" data-lang-en="OUR SERVICES" data-lang-it="I NOSTRI SERVIZI">NAŠE SLUŽBY</a>
