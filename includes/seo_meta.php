...
function renderSchemaOrg($stranka = 'index') {
    ...
    $website = [
        ...
        "potentialAction" => [
            ...
            "target" => [
                "@type" => "EntryPoint",
                "urlTemplate" => "https://wgs-service.cz/cenik?hledat={search_term_string}"
            ],
        ...
        case 'cenik':
            $breadcrumbs = [
                ...
                "itemListElement" => [
                    ...
                    ["@type" => "ListItem", "position" => 2, "name" => "Cenik oprav sedacek a nabytku", "item" => "https://wgs-service.cz/cenik"]
                ]
            ];
            break;
        case 'novareklamace':
